...
| hruser | hr123 | ROLE_HR | hr@workfuture.com |
...
### Vídeo Pitch
**[LINK_DO_VIDEO_PITCH_AQUI]**

Apresentação do projeto, problema, solução e tecnologias utilizadas (3-5 minutos).

### Vídeo Demonstrativo
**[LINK_DO_VIDEO_DEMONSTRATIVO_AQUI]**

Demonstração completa de todas as funcionalidades do sistema (máximo 10 minutos).
...
- **Vídeo Pitch:** `GUIA_VIDEO_PITCH_WORKFUTURE.md` - Roteiro completo do vídeo pitch
- **Vídeo Demonstrativo:** `GUIA_VIDEO_DEMONSTRATIVO_WORKFUTURE.md` - Roteiro completo do vídeo demonstrativo
- **Avaliação:** `AVALIACAO_PROJETO.md` - Análise de avaliação do projeto
- **Resumo:** `RESUMO_FINAL.md` - Checklist final de entrega
